...
ENTRYPOINT ["spicedb", "serve", "--grpc-preshared-key", "'realkeyhere'", "--datastore-engine=postgres", "--datastore-conn-uri='postgres://new:Happy456@localhost:5433/postgres?sslmode=disable'"]
